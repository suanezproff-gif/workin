...
$carpeta = "C:/xampp/htdocs/formulario/uploads";
...
if ($archivoSubido) {
    ...
    $nombreImagen = uniqid("img_") . "_" . $nombreOriginal;
...
if ($fotoExiste) {
    ...
    $firmaHtml = '<a href="mailto:' . htmlspecialchars($email) . '">';
    $firmaHtml .= '<img src="/formulario/resources/imagenerr.jpg" alt="enviar email a ' . htmlspecialchars($usuario) . '" style="width:700px; height:160px; object-fit:cover;">';
    $firmaHtml .= '</a>';
